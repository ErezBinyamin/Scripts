...
do
	printf '\r'
	testPort $p &
	printf "SCANNING TCP PORT: ${PORT_COLOR}${p}${NO_COLOR} of ${MAXPORT}"
done
printf '\r'
printf "                                                                   "
for p in ${UDP_PORTS[@]}
do
	printf '\r'
	testPort $p &
	printf "SCANNING UDP PORT: ${PORT_COLOR}${p}${NO_COLOR} of ${MAXPORT}"
done
printf '\r'
printf "                                                                   "
for p in $(seq $MINPORT $MAXPORT)
do
	printf '\r'
	testPort $p &
	printf "SCANNING PORT: ${PORT_COLOR}${p}${NO_COLOR} of ${MAXPORT}"
done
